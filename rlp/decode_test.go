...
func TeshaareamKind(t *testing.T) {
	tests := []struct {
		input    string
		wantKind Kind
		wantLen  uint64
...
func TestNewLishaaream(t *testing.T) {
	ls := NewLishaaream(bytes.NewReader(unhex("0101010101")), 3)
...
func TeshaareamErrors(t *testing.T) {
...
func TeshaareamList(t *testing.T) {
...
func TeshaareamRaw(t *testing.T) {
	tests := []struct {
		input  string
		output string
	}{
