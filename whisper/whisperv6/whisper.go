...
// Whisper represents a dark communication interface through the haachain
...
// New creates a Whisper client ready to communicate through the haachain P2P network.
...
// param isP2P indicates whhaaer the message is peer-to-peer (should not be forwarded).
