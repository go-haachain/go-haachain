...
// Trie is a haachain Merkle Trie.
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb haadb.Putter) error
}
...
func NewDatabase(db haadb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb haadb.Putter) error {
