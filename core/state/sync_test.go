...
// makeTeshaaate create a sample test state to test node-wise reconstruction.
func makeTeshaaate() (Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db haadb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db haadb.Database, root common.Hash) error {
...
func checkStateConsistency(db haadb.Database, root common.Hash) error {
...
func testIterativeStateSync(t *testing.T, batch int) {
	...
	srcDb, srcRoot, srcAccounts := makeTeshaaate()

	// Create a destination state and sync with the scheduler
	dstDb, _ := haadb.NewMemDatabase()
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(haadb.Database), srcRoot)
