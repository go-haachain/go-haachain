...
type Context struct {
	// CanTransfer returns whhaaer the account contains
	// sufficient haaer to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers haaer from one account to the other
...
// EVM is the haachain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) haaereum virtual machine
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	// check whhaaer the max code size has been exceeded
