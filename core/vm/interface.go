...
type StateDB interface {
	...
	Gehaaate(common.Address, common.Hash) common.Hash
	Sehaaate(common.Address, common.Hash, common.Hash)

	Suicide(common.Address) bool
	HasSuicided(common.Address) bool

	// Exist reports whhaaer the given account exists in state.
	// Notably this should also return true for suicided accounts.
	Exist(common.Address) bool
	// Empty returns whhaaer the given account is empty. Empty
