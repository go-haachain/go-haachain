...
func TestFastVsFullChains(t *testing.T) {
	...
	archiveDb, _ := haadb.NewMemDatabase()
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	lightDb, _ := haadb.NewMemDatabase()
...
//
// https://github.com/haachain/go-haachain/pull/15941
