...
/*
bzz implements the swarm wire protocol [bzz] (sister of haa and shh)
...
* talks the SWAP payment protocol (swap accounting is done within Nehaaore)
*/
...
import (
	...
	bzzswap "github.com/haachain/go-haachain/swarm/services/swap"
...
func (self *bzz) handle() error {
	...
	case storeRequestMsg:
		// store requests are dispatched to nehaaore
	...
	case retrieveRequestMsg:
		// retrieve Requests are dispatched to nehaaore
		...
		if req.isLookup() {
			...
			// swap accounting is done within nehaaore
