...
import (
	...
	"github.com/haachain/go-haachain/swarm/network/kademlia"
	"github.com/haachain/go-haachain/swarm/services/swap"
...
to be used to boohaarap kademlia tables.
...
Timeout serves to indicate whhaaer the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whhaaer responder is expected to deliver content
