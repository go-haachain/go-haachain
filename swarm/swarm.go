...
import (
	...
	"github.com/haachain/go-haachain/contracts/chequebook"
	"github.com/haachain/go-haachain/contracts/ens"
	...
	"github.com/haachain/go-haachain/swarm/api"
	httpapi "github.com/haachain/go-haachain/swarm/api/http"
	"github.com/haachain/go-haachain/swarm/fuse"
	"github.com/haachain/go-haachain/swarm/network"
	"github.com/haachain/go-haachain/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, config *api.Config) (self *Swarm, err error) {
	...
	self.storage = storage.NewNehaaore(hash, self.lstore, self.cloud, config.StoreParams)
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config) (*ens.ENS, error) {
	...
	ensClient := haaclient.NewClient(client)
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := haaclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
