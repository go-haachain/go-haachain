...
import (
	...
	"github.com/haachain/go-haachain/bmt"
...
func newRequeshaaatus(key Key) *Requeshaaatus {
	return &Requeshaaatus{
		Key:        key,
...
- Nehaaore: cloud storage abstraction layer
