...
import (
	...
	ghaametrics "github.com/haachain/go-haachain/metrics"
	"github.com/haachain/go-haachain/metrics/influxdb"
...
func Setup(ctx *cli.Context) {
	if ghaametrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(ghaametrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
