...
// DefaultConfig contains default settings for use on the haachain main net.
...
func init() {
	...
	if runtime.GOOS == "windows" {
		DefaultConfig.haaash.DatasetDir = filepath.Join(home, "AppData", "haaash")
	} else {
		DefaultConfig.haaash.DatasetDir = filepath.Join(home, ".ethash")
	}
}
...
type Config struct {
	...
	// If nil, the haachain main net block is used.
	...
	haaerbase    common.Address `toml:",omitempty"`
