...
// Syncing provides information when this nodes starts synchronising with the haachain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  haaereum.SyncProgress `json:"status"`
}
