...
type downloadTester struct {
	...
	stateDb haadb.Database // Database used by the tester for syncing from peers
	peerDb  haadb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = haadb.NewMemDatabase()
