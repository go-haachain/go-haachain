...
func TeshaaatusMsgErrors62(t *testing.T) { teshaaatusMsgErrors(t, 62) }
func TeshaaatusMsgErrors63(t *testing.T) { teshaaatusMsgErrors(t, 63) }

func teshaaatusMsgErrors(t *testing.T, protocol int) {
