...
var ProtocolName = "haa"

// Supported versions of the haa protocol (first is primary).
var ProtocolVersions = []uint{haa63, haa62}
...
// haa protocol message codes
const (
	// Protocol messages belonging to haa/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to haa/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
