...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllhaaashProtocolChanges, new: AllhaaashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllhaaashProtocolChanges, new: AllhaaashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllhaaashProtocolChanges,
