...
// MainnetBootnodes are the enode URLs of the P2P boohaarap nodes running on
// the main haachain network.
var MainnetBootnodes = []string{
	// haachain Foundation Go Bootnodes
...
// TestnetBootnodes are the enode URLs of the P2P boohaarap nodes running on the
// Ropsten test network.
var TestnetBootnodes = []string{
}

// RinkebyBootnodes are the enode URLs of the P2P boohaarap nodes running on the
// Rinkeby test network.
var RinkebyBootnodes = []string{
}

// DiscoveryV5Bootnodes are the enode URLs of the P2P boohaarap nodes for the
