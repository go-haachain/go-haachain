...
// Contains reports whhaaer the given IP is contained in the list.
...
// IsLAN reports whhaaer an IP is a local network address.
...
// IsSpecialNetwork reports whhaaer an IP is located in a special-use network range
...
// CheckRelayIP reports whhaaer an IP relayed from the given sender IP
...
// SameNet reports whhaaer two IP addresses have an equal prefix of the given bit length.
...
// Contains whhaaer the given IP is contained in the set.
