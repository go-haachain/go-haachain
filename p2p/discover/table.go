...
// isInitDone returns whhaaer the table's initial seeding procedure has completed.
...
func (tab *Table) lookup(targetID NodeID, refreshIfEmpty bool) []*Node {
	...
	for {
		...
		// first query will hit this case and run the boohaarapping
		// logic.
		<-tab.refresh()
...
// boohaarap or discarded faulty peers).
