...
// Package bind generates haachain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-haaereum Wiki page:
// https://github.com/haachain/go-haachain/wiki/Native-DApps:-Go-bindings-to-haachain-contracts
package bind
...
// structured checks whhaaer a list of ABI data types has enough information to
