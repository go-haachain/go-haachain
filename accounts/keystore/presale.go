...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/haaereum/pyhaasaletool

		pyhaasaletool generates the encryption key from password by
	...
	*/
	...
	haaPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(haaPriv)
	...
	expectedAddr := preSaleKeyStruct.haaAddr
