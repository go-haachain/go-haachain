...
// See https://github.com/haaereum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whhaaer the event notification loop is running
...
// HasAddress reports whhaaer a key with the given address is present.
...
// ImportPreSaleKey decrypts the given haachain presale wallet and stores
