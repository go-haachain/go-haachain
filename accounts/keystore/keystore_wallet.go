...
// Status implements accounts.Wallet, returning whhaaer the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain haaereum.ChainStateReader) {}
