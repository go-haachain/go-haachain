...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ghaa.ipc", false, filepath.Join(os.TempDir(), "ghaa.ipc")},
		{"data", "ghaa.ipc", false, "data/ghaa.ipc"},
		{"data", "./ghaa.ipc", false, "./ghaa.ipc"},
		{"data", "/ghaa.ipc", false, "/ghaa.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ghaa.ipc", true, `\\.\pipe\ghaa.ipc`},
		{"data", "ghaa.ipc", true, `\\.\pipe\ghaa.ipc`},
		{"data", `\\.\pipe\ghaa.ipc`, true, `\\.\pipe\ghaa.ipc`},
	}
