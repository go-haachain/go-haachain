...
// Transaction represents a single haachain transaction.
...
// Deprecated: use haachainClient.TransactionSender
...
func (r *Receipt) GetPoshaaate() []byte         { return r.receipt.Poshaaate }
