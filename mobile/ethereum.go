...
// Contains all the wrappers from the go-haaereum root package.
...
// the haachain network.
type SyncProgress struct {
	progress haaereum.SyncProgress
}

func (p *SyncProgress) GehaaartingBlock() int64 { return int64(p.progress.StartingBlock) }
