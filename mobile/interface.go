...
func (i *Interface) Sehaaring(str string)          { i.object = &str }
func (i *Interface) Sehaarings(strs *Strings)      { i.object = &strs.strs }
...
func (i *Interface) SetDefaulhaaring()    { i.object = new(string) }
func (i *Interface) SetDefaulhaarings()   { i.object = new([]string) }
...
func (i *Interface) Gehaaring() string        { return *i.object.(*string) }
func (i *Interface) Gehaarings() *Strings     { return &Strings{*i.object.(*[]string)} }
