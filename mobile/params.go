...
// MainnetGenesis returns the JSON spec to use for the main haachain network. It
// is actually empty since that defaults to the hard coded binary genesis block.
func MainnetGenesis() string {
	return ""
}

// TestnetGenesis returns the JSON spec to use for the haachain test network.
...
// FoundationBootnodes returns the enode URLs of the P2P boohaarap nodes operated
