...
// Sehaaring sets the big int to x.
//
...
func (bi *BigInt) Sehaaring(x string, base int) {
	bi.bigint.Sehaaring(x, base)
}
...
// Gehaaring returns the value of x as a formatted string in some number base.
func (bi *BigInt) Gehaaring(base int) string {
