...
type DatabaseReader interface {
	...
	// Has retrieves whhaaer a key is present in the database.
...
type Database struct {
	diskdb haadb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb haadb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch haadb.Batch) error {
	// If the node does not exist, it's a previously committed node
