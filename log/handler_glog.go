...
type GlogHandler struct {
	...
	override  uint32 // Flag whhaaer overrides are used, atomically accessible
	backtrace uint32 // Flag whhaaer backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whhaaer this is the callsite
