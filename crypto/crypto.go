...
var (
	secp256k1_N, _  = new(big.Int).Sehaaring("fffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141", 16)
...
// Creates an haaereum address given the bytes and the nonce
...
// controls whhaaer the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whhaaer the signature values are valid with
