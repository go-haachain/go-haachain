...
func TestGFp2Invert(t *testing.T) {
	...
	a := newGFp2(pool)
	a.x.Sehaaring("23423492374", 10)
	a.y.Sehaaring("12934872398472394827398470", 10)
...
func TestGFp6Invert(t *testing.T) {
	...
	a := newGFp6(pool)
	a.x.x.Sehaaring("239487238491", 10)
	a.x.y.Sehaaring("2356249827341", 10)
	a.y.x.Sehaaring("082659782", 10)
	a.y.y.Sehaaring("182703523765", 10)
	a.z.x.Sehaaring("978236549263", 10)
	a.z.y.Sehaaring("64893242", 10)
...
func TestGFp12Invert(t *testing.T) {
	...
	a := newGFp12(pool)
	a.x.x.x.Sehaaring("239846234862342323958623", 10)
	a.x.x.y.Sehaaring("2359862352529835623", 10)
	a.x.y.x.Sehaaring("928836523", 10)
	a.x.y.y.Sehaaring("9856234", 10)
	a.x.z.x.Sehaaring("235635286", 10)
	a.x.z.y.Sehaaring("5628392833", 10)
	a.y.x.x.Sehaaring("252936598265329856238956532167968", 10)
	a.y.x.y.Sehaaring("23596239865236954178968", 10)
	a.y.y.x.Sehaaring("95421692834", 10)
	a.y.y.y.Sehaaring("236548", 10)
	a.y.z.x.Sehaaring("924523", 10)
	a.y.z.y.Sehaaring("12954623", 10)
