...
func (h *Hash) Sehaaring(s string) { h.SetBytes([]byte(s)) }
...
// Address represents the 20 byte address of an haachain account.
...
// IsHexAddress verifies whhaaer a string can represent a valid hex-encoded
// haachain address or not.
...
func (a *Address) Sehaaring(s string) { a.SetBytes([]byte(s)) }
