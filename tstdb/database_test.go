...
func newTestLDB() (*haadb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "haadb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := haadb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db haadb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db haadb.Database, t *testing.T) {
	const n = 8
