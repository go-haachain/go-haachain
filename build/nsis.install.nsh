Name "ghaa ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/haachain/go-haachain/issues"
!define UPDATEURL "https://github.com/haachain/go-haachain/releases"
!define ABOUTURL "https://github.com/haachain/go-haachain#haaereum-go"
...
# Install ghaa binary
Section "Ghaa" Ghaa_IDX
  SetOutPath $INSTDIR
  file {{.Ghaa}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\ghaa.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\ghaa.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Ghaa incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Ghaa outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Ghaa UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Ghaa incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\ghaa.exe" "" "" "haachain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Ghaa outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\ghaa.exe" "" "" "haachain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Ghaa UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\ghaa.exe" "" "" "haachain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/haaereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "haaEREUM_SOCKET" "R" "HKLM" "\\.\pipe\ghaa.ipc"
  ${EnvVarUpdate} $0 "haaEREUM_SOCKET" "A" "HKLM" "\\.\pipe\ghaa.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${Ghaa_IDX}
    SectionGetSize ${Ghaa_IDX} $0
