...
Please review the resulting diff to check whhaaer the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-haaereum authors for copyright purposes.\n\n"
)
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-haaereum library"
	}
	return "the go-haaereum library"
}
