...
# 1. install ghaa for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for ghaa
# 5. create ghaa, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable haaEREUM_SOCKET
...
!define GROUPNAME "haachain"
!define APPNAME "Ghaa"
!define DESCRIPTION "Official Go implementation of the haachain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since ghaa is installed global
