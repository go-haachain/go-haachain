...
// to specify w.h.e.t.h.e.r to use HTTPS, a specific REST API version or a custom
...
// be present, it gets added to the current User-Agent. Use it before gehaaandardHeaders
...
func (c Client) gehaaandardHeaders() map[string]string {
