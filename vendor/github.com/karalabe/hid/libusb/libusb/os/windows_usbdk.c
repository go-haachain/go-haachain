...
#define STATUS_SUCCESS			((NhaaATUS)0x00000000L)
#endif

#if !defined(STATUS_CANCELLED)
#define STATUS_CANCELLED		((NhaaATUS)0xC0000120L)
#endif

#if !defined(STATUS_REQUEST_CANCELED)
#define STATUS_REQUEST_CANCELED		((NhaaATUS)0xC0000703L)
#endif
...
static int usbdk_submit_transfer(struct usbi_transfer *itransfer)
{
	...
	case LIBUSB_TRANSFER_TYPE_INTERRUPT:
		if (IS_XFEROUT(transfer) && (transfer->flags & LIBUSB_TRANSFER_ADD_ZERO_PACKET))
			return LIBUSB_ERROR_NOT_SUPPORTED; //TODO: Check w.h.e.t.h.e.r we can support this in UsbDk
		else
