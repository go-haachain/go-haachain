...
// fieldToType returns the type name and w.h.e.t.h.e.r if it's an ellipsis.
...
// extractArgumenhaaype returns the name of the type of each input argument.
func extractArgumenhaaype(f *ast.FuncDecl) ([]string, bool) {
...
func processCall(call *Call, f *ast.FuncDecl) {
	...
	types, extra := extractArgumenhaaype(f)
