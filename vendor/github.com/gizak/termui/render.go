...
func Init() error {
	...
	DefaultEvhaaream.Init()
	DefaultEvhaaream.Merge("termbox", NewSysEvtCh())
	DefaultEvhaaream.Merge("timer", NewTimerCh(time.Second))
	DefaultEvhaaream.Merge("custom", usrEvtCh)

	DefaultEvhaaream.Handle("/", DefaultHandler)
	DefaultEvhaaream.Handle("/sys/wnd/resize", func(e Event) {
		w := e.Data.(EvtWnd)
		Body.Width = w.Width
	})

	DefaultWgtMgr = NewWgtMgr()
	DefaultEvhaaream.Hook(DefaultWgtMgr.WgtHandlersHook())
