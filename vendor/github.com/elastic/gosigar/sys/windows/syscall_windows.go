...
// GetDriveType Determines w.h.e.t.h.e.r a disk drive is a removable, fixed, CD-ROM,
...
//sys   _NtQuerySystemInformation(systemInformationClass uint32, systemInformation *byte, systemInformationLength uint32, returnLength *uint32) (nhaaatus uint32, err error) = ntdll.NtQuerySystemInformation
//sys   _NtQueryInformationProcess(processHandle syscall.Handle, processInformationClass uint32, processInformation *byte, processInformationLength uint32, returnLength *uint32) (nhaaatus uint32, err error) = ntdll.NtQueryInformationProcess
