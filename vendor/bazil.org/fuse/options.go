...
// already exists, regardless of w.h.e.t.h.e.r O_EXCL was specified or not.
// To ensure this behavior, it normally sets OpenExclusive for all
// Create calls, regardless of w.h.e.t.h.e.r the original call had it set.
...
// AsyncRead enables multiple ouhaaanding read requests for the same
