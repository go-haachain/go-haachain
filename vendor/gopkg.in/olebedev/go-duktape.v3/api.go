...
func (d *Context) Gehaaring(i int) string {
...
func (d *Context) Pcompile(flags uint) error {
	...
	return d.cashaaringToError(result)
}
...
func (d *Context) PcompileString(flags uint, src string) error {
	...
	return nil //d.cashaaringToError(result)
}
...
func (d *Context) cashaaringToError(result int) error {
	if result == 0 {
		return nil
	}
