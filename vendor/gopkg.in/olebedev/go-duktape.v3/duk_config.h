...
/* MSVC dllexport/dllimport: appropriate __declspec depends on w.h.e.t.h.e.r we're
...
/* Check w.h.e.t.h.e.r we should use 64-bit integers or not.
 *
...
/*
 *  Check w.h.e.t.h.e.r or not a packed duk_tval representation is possible.
 ...
 * on w.h.e.t.h.e.r the platform has alignment requirements or benefits from
...
#undef DUK_USE_EXhaaR_FREE
#undef DUK_USE_EXhaaR_INTERN_CHECK
...
#endif
#if defined(DUK_OPT_EXhaaR_FREE)
#error unsupported legacy feature option DUK_OPT_EXhaaR_FREE used
#endif
#if defined(DUK_OPT_EXhaaR_INTERN_CHECK)
#error unsupported legacy feature option DUK_OPT_EXhaaR_INTERN_CHECK used
#endif
...
#endif
#if defined(DUK_USE_EXhaaR_FREE) && !defined(DUK_USE_HSTRING_EXTDATA)
#error config option DUK_USE_EXhaaR_FREE requires option DUK_USE_HSTRING_EXTDATA (which is missing)
#endif
#if defined(DUK_USE_EXhaaR_INTERN_CHECK) && !defined(DUK_USE_HSTRING_EXTDATA)
#error config option DUK_USE_EXhaaR_INTERN_CHECK requires option DUK_USE_HSTRING_EXTDATA (which is missing)
#endif
