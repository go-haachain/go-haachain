...
// Package tests implements execution of haachain JSON tests.
package tests
...
type btJSON struct {
	...
	Post      core.GenesisAlloc     `json:"poshaaate"`
...
func (t *BlockTest) Run() error {
	...
	if err = t.validatePoshaaate(newDB); err != nil {
...
/* See https://github.com/haaereum/tests/wiki/Blockchain-Tests-II

   Whhaaer a block is valid or not is a bit subtle, it's defined by presence of
...
func (t *BlockTest) validatePoshaaate(statedb *state.StateDB) error {
