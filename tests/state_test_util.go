...
// See https://github.com/haaereum/EIPs/issues/176 for the test format specification.
...
type stJSON struct {
	...
	Post map[string][]stPoshaaate `json:"post"`
}

type stPoshaaate struct {
...
func MakePreState(db haadb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPoshaaate) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/haaereum/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
