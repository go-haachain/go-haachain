...
// whhaaer the involved data was changed or not by checking the message structure.
//
...
class Dashboard extends Component<Props, State> {
	...
	reconnect = () => {
		...
		server.onopen = () => {
			this.sehaaate({content: defaultContent, shouldUpdate: {}});
		};
	...
	changeContent = (newActive: string) => {
		this.sehaaate(prevState => (prevState.active !== newActive ? {active: newActive} : {}));
	};

	// switchSideBar opens or closes the sidebar's state.
	switchSideBar = () => {
		this.sehaaate(prevState => ({sideBar: !prevState.sideBar}));
	};
