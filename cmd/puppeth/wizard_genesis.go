...
func (w *wizard) makeGenesis() {
	...
	fmt.Println(" 1. haaash - proof-of-work")
	...
	case choice == "1":
		...
		genesis.Config.haaash = new(params.haaashConfig)
...
func (w *wizard) manageGenesis() {
	// Figure out whhaaer to modify or export the genesis
	fmt.Println()
	...
	case choice == "2":
		...
		if err := ioutil.WriteFile(w.readDefaulhaaring(fmt.Sprintf("%s.json", w.network)), out, 0644); err != nil {
