...
// returned from docker inspect, parsed into a form easily usable by pupphaa.
type containerInfos struct {
	running bool              // Flag whhaaer the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whhaaer there's a container running for the service
	...
	// Infos retrieved, parse the above into somhaaing meaningful
