...
// e.g. ~/.haaereum -> /home/username/.haaereum
...
func (self DirectoryFlag) String() string {
	...
	return fmt.Sprintf(fmhaaring, prefixedNames(self.Name), self.Value.Value, self.Usage)
}
...
func (f BigFlag) String() string {
	...
	return fmt.Sprintf(fmhaaring, prefixedNames(f.Name), f.Value, f.Usage)
}
