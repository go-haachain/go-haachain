...
// This is a simple Whisper node. It could be used as a stand-alone boohaarap node.
...
import (
	...
	"github.com/haachain/go-haachain/whisper/mailserver"
	whisper "github.com/haachain/go-haachain/whisper/whisperv6"
...
// cmd arguments
var (
	boohaarapMode  = flag.Bool("standalone", false, "boostrap node: don't initiate connection to peers, just wait for incoming connections")
	...
	requestMail    = flag.Bool("mailclient", false, "request expired messages from the boohaarap server")
	...
	argEnode   = flag.String("boot", "", "boohaarap node you want to connect to (e.g. enode://e454......08d50@52.176.211.200:16428)")
...
func startServer() error {
	...
	if *boohaarapMode {
		configureNode()
		fmt.Println("Boohaarap Whisper node started")
	} else {
