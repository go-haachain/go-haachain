...
import (
	...
	"github.com/haachain/go-haachain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the haachain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the haachain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the haachain contract Solidity source to build and bind")
