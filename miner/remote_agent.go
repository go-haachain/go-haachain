...
type RemoteAgent struct {
	...
	running int32 // running indicates whhaaer the agent is active. Call atomically
}
...
// whhaaer the solution was accepted or not (not can be both a bad pow as well as
