...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for haaSubscribe requests
}
...
// haaSubscribe registers a subscripion under the "haa" namespace.
func (c *Client) haaSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "haa", channel, args...)
}
...
func (c *Client) handleResponse(msg *jsonrpcMessage) {
	...
	// indicates success. haaSubscribe gets unblocked in either case through
	// the op.resp channel.
	defer close(op.resp)
	if msg.Error != nil {
		op.err = msg.Error
...
// A ClientSubscription represents a subscription established through haaSubscribe.
