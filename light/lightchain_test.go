...
func makeHeaderChain(parent *types.Header, n int, db haadb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (haadb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() haadb.Database {
	return odr.db
}
